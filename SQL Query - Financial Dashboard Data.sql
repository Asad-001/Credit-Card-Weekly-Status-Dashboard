...
-- 3. Copying csv data into SQL (remember to update the file name and file location in below query)
...
-- If we are getting below error, then use the below point:  
...
-- copying additional data (week-53) in cust_detail table (remember to update the file name and file location in below query)
